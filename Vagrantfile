...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "node_1" do |node_1|
    ...
    node_1.vm.network "private_network", ip: "192.168.16.103"
    node_1.vm.provision "shell", path: "provision/node.sh", privileged: false
  ...
  config.vm.define "node_2" do |node_2|
    ...
    node_2.vm.network "private_network", ip: "192.168.16.104"
    node_2.vm.provision "shell", path: "provision/node.sh", privileged: false
  ...
  config.vm.define "node_3" do |node_3|
    ...
    node_3.vm.network "private_network", ip: "192.168.16.105"
    node_3.vm.provision "shell", path: "provision/node.sh", privileged: false
